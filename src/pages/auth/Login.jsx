...
export default function Login() {
  ...
  const fillDemo = (e) => { setEmail('admin@zipkart.in'); setPassword('Admin@123'); clearError(); };
  const fillOps  = (e) => { setEmail('ops@zipkart.in');   setPassword('Ops@1234');  clearError(); };
    ...
    <AuthLayout>
      ...
      <div className="bg-orange-50 border border-orange-200 rounded-xl p-3.5 flex gap-3 mb-6">
        ...
        <div className="text-xs text-orange-700 leading-relaxed">
          ...
          <span className="block mt-1 text-orange-600">Then OTP: <code className="font-mono bg-orange-100 px-1 rounded">123456</code></span>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          {loading
            ...
            : <><ArrowRight size={16} /> Continue to 2FA</>
          }
        </button>
      </form>
      ...
      <div className="flex items-center gap-3 my-5">
        ...
        <span className="text-xs text-gray-400">or use another account</span>
        <div className="flex-1 h-px bg-gray-200" />
      </div>
